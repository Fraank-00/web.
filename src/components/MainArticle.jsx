  ...
  return (
    <section className='mb-12'>
      <picture>
        ...
        <img src={imageMobile} alt="Major Article" className="w-full h-auto" />
      </picture>
      <div className="sm:flex gap-6">
        ...
        <div className="flex-1 pt-9">
          ...
          <button className="bg-red-500 text-white font-bold uppercase tracking-wide w-[185px] h-[48px] rounded-md hover:bg-gray-900 transition-colors">
            Read more
          </button>
        </div>
      </div>
